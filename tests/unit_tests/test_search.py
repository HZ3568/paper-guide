...
def test_openalex_parsers_preserve_full_abstract() -> None:
    ...
    assert arxiv_tool._parse_oa_result(work)["abstract"] == expected
    assert openalex_mcp_server._parse(work)["abstract"] == expected
