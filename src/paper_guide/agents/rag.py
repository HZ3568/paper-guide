...
from paper_guide.prompts import RAG_PROMPT
from paper_guide.tools.rag_tool import retrieve_context
...
def _format_context(chunks: list[dict]) -> str:
    ...
    for i, chunk in enumerate(chunks, 1):
        ...
        parts.append(f"【检索块 {i}｜{kind_label}】来源: {source}\n{content}")
